document.addEventListener('DOMContentLoaded', (event) => {
    document.getElementById('myForm').addEventListener('submit', function (event) {
        ...
        var namaDepan = document.getElementById('exampleInputNameDepan').value;
        var namaBelakang = document.getElementById('exampleInputNameBelakang').value;
        var email = document.getElementById('exampleInputEmail').value;
        var jumlah = document.getElementById('exampleInputNumber').value;

        // Cek apakah nama hanya mengandung huruf
        if (!/^[a-zA-Z\s]*$/.test(namaDepan) || !/^[a-zA-Z\s]*$/.test(namaBelakang)) {
        ...
        button.addEventListener('click', function () {
            ...
            submitbutton.addEventListener('click', function () {
                ...
                modalBody.textContent = 'Halo, nama saya ' + namaDepan + ' ' + namaBelakang + ' dengan email ' + email + '. Saya memiliki hobi sejumlah ' + jumlah + ' pilihan yaitu ' + pilihanText + ' dan saya menyukai ' + pilihan + '.';
